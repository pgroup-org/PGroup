...
var PhaseListLen = document.querySelectorAll(".container .cont-wrap .phases-list li").length;
const PhaseList = document.querySelector(".container .cont-wrap .phases-list");
...
document.addEventListener("click", (e) => {
  if(e.target.matches(".container .cont-wrap .upper-row form input[type=submit]")){
    ...
    ul = document.querySelector(".container .cont-wrap .phases-list");
